...
- Kenneth Heafield, Hiroaki Hayashi, **Yusuke Oda**, Ioannis Konstas, Andrew Finch, Graham Neubig, Xian Li, Alexandra Birch
  <br>[Findings of the Fourth Workshop on Neural Generation and Translation](https://www.aclweb.org/anthology/2020.ngt-1.1/)
  <br>In Proc. WNGT, July, 2020.
  
- Nobushige Doi, **Yusuke Oda**, Toshiaki Nakazawa
  <br>[TDDC: Timely Disclosure Documents Corpus](https://www.aclweb.org/anthology/2020.lrec-1.459/)
  <br>In Proc. LREC, Marseille, France, May, 2020.
...
- Hiroaki Hayashi, **Yusuke Oda**, Alexandra Birch, Ioannis Konstas, Andrew Finch, Minh-Thang Luong, Graham Neubig, Katsuhito Sudoh
  ...
  <br>In Proc. WNGT, Hong Kong, November, 2019.

## 2018

- Alexandra Birch, Andrew Finch, Minh-Thang Luong, Graham Neubig, **Yusuke Oda**
  <br>[Findings of the Second Workshop on Neural Machine Translation and Generation](https://arxiv.org/abs/1806.02940)
  <br>In Proc: WNMT, July, 2018.
...
- **Yusuke Oda**, Katsuhito Sudoh, Satoshi Nakamura, Masao Utiyama, Eiichiro Sumita
  <br>[A Simple and Strong Baseline: NAIST-NICT Neural Machine Translation System for WAT2017 English-Japanese Translation Task](http://aclweb.org/anthology/W17-5712)
  <br>In Proc. WAT, Taipei, Taiwan, November, 2017.
...
- Toshiaki Nakazawa, Shohei Higashiyama, Chenchen Ding, Hideya Mino, Isao Goto, Hideto Kazawa, **Yusuke Oda**, Graham Neubig, Sadao Kurohashi
  <br>[Overview of the 4th Workshop on Asian Translation](https://www.aclweb.org/anthology/W17-5701/)
  <br>In Proc. WAT, Taipei, Taiwan, November, 2017.

- Panyam Chandrasekarasastry Nagesh, 江原 遥, 徳永 拓之, 鶴岡 慶雅, **小田 悠介**, 渡部 有隆
  <br>オンラインジャッジサイトのデータセットのプログラム自動生成への応用
  <br>In 第20回情報論的学習理論ワークショップ (IBIS2017), 東京, 11月, 2017.
  
- Makoto Morishita, **Yusuke Oda**, Graham Neubig, Koichiro Yoshino, Katsuhito Sudoh, Satoshi Nakamura
  <br>[An Empirical Study of Mini-Batch Creation Strategies for Neural Machine Translation](http://aclweb.org/anthology/W17-3208)
  <br>In Proc. WNMT, Vancouver, Canada, August, 2017.
  
- **Yusuke Oda**, Philip Arthur, Graham Neubig, Koichiro Yoshino, Satoshi Nakamura
  <br>[Neural Machine Translation via Binary Code Prediction](http://aclweb.org/anthology/P17-1079)
  <br>In Proc. ACL, Vancouver, Canada, August, 2017.
  
- 独立行政法人情報処理推進機構　AI白書編集委員会
  <br>[AI白書 2017](https://www.ipa.go.jp/about/report/ai/201707.html)
  <br>7月, 2017.
...
- Graham Neubig, Chris Dyer, Yoav Goldberg, Austin Matthews, Waleed Ammar, Antonios Anastasopoulos, Miguel Ballesteros, David Chiang, Daniel Clothiaux, Trevor Cohn, Kevin Duh, Manaal Faruqui Cynthia Gan, Dan Garrette, Yangfeng Ji, Lingpeng Kong, Adhiguna Kuncoro, Gaurav Kumar, Chaitanya Malaviya, Paul Michel, **Yusuke Oda**, Matthew Richardson, Naomi Saphra, Swabha Swayamdipta, Pengcheng Yin
  <br>[DyNet: The Dynamic Neural Network Toolkit](https://arxiv.org/abs/1701.03980)
  <br>In arXiv:1701.03980, January, 2017.
  
## 2016

- **Yusuke Oda**, Taku Kudo, Tetsuji Nakagawa, Taro Watanabe
  <br>[Phrase-based Machine Translation using Multiple Preordering Candidates](http://aclweb.org/anthology/C16-1134)
  <br>In Proc. COLING, Osaka, Japan, December, 2016.

- 帖佐 克己, **小田 悠介**, Sakriani Sakti, 吉野 幸一郎, 中村 哲
...
- **Yusuke Oda**, Graham Neubig, Sakriani Sakti, Tomoki Toda, Satoshi Nakamura
  ...
  <br>In Proc. ACL-IJCNLP, Beijing, China, July, 2015.
  
- **Yusuke Oda**, Graham Neubig, Sakriani Sakti, Tomoki Toda, Satoshi Nakamura
  <br>[Ckylark: A More Robust PCFG-LA Parser](http://aclweb.org/anthology/N15-3009)
...
- **小田 悠介**
  <br>ACL2014 参加報告 (その1)
  <br>In 言語処理学会 ニュースレター, Vol. 21, No. 4, 10月, 2014.

- **小田 悠介**
  <br>ACL 参加報告 (1)
  <br>In NLP若手の会 第9回シンポジウム, 神奈川, 9月, 2014.
  
- 冨田 隼平, 水上 雅博, **小田 悠介**, 山本 誠一
  <br>人による翻訳文への翻訳自動評価法の適用に関する考察
  <br>In NLP若手の会 第9回シンポジウム, 神奈川, 9月, 2014.

- **小田 悠介**
  <br>ACL2014 参加報告 (1)
  <br>In 情報処理学会 第217回自然言語処理研究会, 北海道, 7月, 2014.
  
- **Yusuke Oda**, Graham Neubig, Sakriani Sakti, Tomoki Toda, Satoshi Nakamura
  <br>[Optimizing Segmentation Strategies for Simultaneous Speech Translation](http://aclweb.org/anthology/P14-2090)
  <br>In Proc. ACL, Baltimore, USA, June, 2014.
  
- **小田 悠介**, ニュービッグ グラム, サクティ サクリアニ, 戸田 智基, 中村 哲
...
- **小田 悠介**, Graham Neubig, Sakriani Sakti, 戸田 智基, 中村 哲
  <br>回答選択型QAシステムにおける教師なし意味解析の利用
  <br>In ALAGIN & NLP若手の会 合同シンポジウム, 東京, 9月, 2013.

- **小田 悠介**, 若林 茂
  <br>プログラム間の類似性の定量化手法
  <br>In 神戸高専研究紀要, 第51号, 3月, 2013.
...
- **小田 悠介**, 上村 康輔, 若林 茂
  <br>プログラム間の類似性の定量化手法
  <br>In 教育システム情報学会 第37回全国大会, 千葉, 8月, 2012.

## 2010

- **小田 悠介**, 長谷 芳樹
  <br>ストレス・フリーな連続ウェーブレット変換実装 ～NVIDIA CUDAを用いた高速化～
  <br>In 日本音響学会 関西支部 第13回若手研究者交流研究発表会 発表資料集, 京都, 12月, 2010.
